...
// const BACKEND_URL = `https://localhost:${BACKEND_PORT}/api/be`;
...
export default {
  getSocialLoginUrl(socialType) {
    return `${BACKEND_URL}/oauth2/authorization/${socialType}?redirect_uri=https://j7d210.p.ssafy.io/oauth/redirect`;
  },
