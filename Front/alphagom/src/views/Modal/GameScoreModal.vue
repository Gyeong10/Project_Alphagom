  ...
  <div class="score-modal" tabindex="-1">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button v-if="store.stage.value !== 'sky'"
        @click="getNextStage()" class="next-btn" data-bs-dismiss="modal">다음 탐험으로</button>        
        <button v-if="store.stage.value === 'sky'"
        @click="getNextStage()" class="next-btn" data-bs-dismiss="modal">순위 보기!</button>        
      </div>
    </div>
  </div>
